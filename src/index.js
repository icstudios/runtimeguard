...
async function runtime() {
    ...
    console.log(`RuntimeGuard v${VERSION}`);
    ...
    try {
        ...
        if (!fs.existsSync(path.join(__dirname + "/lib/errors.js"))) {
            console.log(`The RuntimeGuard core dependency "/lib/errors.js" does not exist. Please reinstall this app.`);
            return process.exit(1);
        } if (!fs.existsSync(path.join(__dirname + "/lib/module.js"))) {
            console.log(`The RuntimeGuard core dependency "/lib/module.js" does not exist. Please reinstall this app.`);
            return process.exit(1);
        };
    };
